...
constexpr EnumValueSet VkFramebufferCreateFlagsSets[] = {
    {"IMAGELESS_BIT_KHR", 0x00000001, true},
    {"IMAGELESS", 0x00000001, false},
};

constexpr EnumValueSet VkRenderPassCreateFlagsSets[] = {
...
constexpr EnumValueSet VkSamplerCreateFlagsSets[] = {
...
constexpr EnumValueSet VkPipelineLayoutCreateFlagsSets[] = {
    {"RESERVED_0_BIT_AMD", 0x00000001, false},
    {"RESERVED_1_BIT_AMD", 0x00000002, false},
};

constexpr EnumValueSet VkPipelineCacheCreateFlagsSets[] = {
...
constexpr EnumValueSet VkPipelineDepthStencilStateCreateFlagsSets[] = {
...
constexpr EnumValueSet VkPipelineColorBlendStateCreateFlagsSets[] = {
    {"RASTERIZATION_ORDER_ATTACHMENT_ACCESS_BIT_ARM", 0x00000001, false},
};

constexpr EnumValueSet VkPipelineShaderStageCreateFlagsSets[] = {
...
constexpr EnumValueSet VkDescriptorSetLayoutCreateFlagsSets[] = {
...
constexpr EnumValueSet VkInstanceCreateFlagsSets[] = {
    {"ENUMERATE_PORTABILITY_BIT_KHR", 0x00000001, false},
};

constexpr EnumValueSet VkDeviceQueueCreateFlagsSets[] = {
    {"PROTECTED", 0x00000001, false},
    {"RESERVED_1_BIT_QCOM", 0x00000002, false},
};

constexpr EnumValueSet VkQueueFlagsSets[] = {
...
constexpr EnumValueSet VkMemoryPropertyFlagsSets[] = {
...
constexpr EnumValueSet VkMemoryHeapFlagsSets[] = {
    {"DEVICE_LOCAL", 0x00000001, false},
...
constexpr EnumValueSet VkAccessFlagsSets[] = {
...
constexpr EnumValueSet VkBufferUsageFlagsSets[] = {
...
constexpr EnumValueSet VkBufferCreateFlagsSets[] = {
...
constexpr EnumValueSet VkShaderStageFlagsSets[] = {
...
constexpr EnumValueSet VkImageUsageFlagsSets[] = {
    {"TRANSFER_SRC", 0x00000001, false},
    {"TRANSFER_DST", 0x00000002, false},
...
constexpr EnumValueSet VkImageCreateFlagsSets[] = {
    {"SPARSE_BINDING", 0x00000001, false},
    {"SPARSE_RESIDENCY", 0x00000002, false},
    {"SPARSE_ALIASED", 0x00000004, false},
...
constexpr EnumValueSet VkImageViewCreateFlagsSets[] = {
...
constexpr EnumValueSet VkPipelineCreateFlagsSets[] = {
...
constexpr EnumValueSet VkColorComponentFlagsSets[] = {
    {"R", 0x00000001, false},
    {"G", 0x00000002, false},
    {"B", 0x00000004, false},
    {"A", 0x00000008, false},
...
constexpr EnumValueSet VkFenceCreateFlagsSets[] = {
    {"SIGNALED", 0x00000001, false},
};

constexpr EnumValueSet VkFormatFeatureFlagsSets[] = {
...
constexpr EnumValueSet VkQueryControlFlagsSets[] = {
    {"PRECISE", 0x00000001, false},
};

constexpr EnumValueSet VkQueryResultFlagsSets[] = {
    {"64", 0x00000001, false},
...
constexpr EnumValueSet VkImageAspectFlagsSets[] = {
...
constexpr EnumValueSet VkSparseMemoryBindFlagsSets[] = {
    {"METADATA", 0x00000001, false},
};

constexpr EnumValueSet VkSparseImageFormatFlagsSets[] = {
    {"SINGLE_MIPTAIL", 0x00000001, false},
    {"ALIGNED_MIP_SIZE", 0x00000002, false},
    {"NONSTANDARD_BLOCK_SIZE", 0x00000004, false},
};

constexpr EnumValueSet VkSubpassDescriptionFlagsSets[] = {
...
constexpr EnumValueSet VkPipelineStageFlagsSets[] = {
...
constexpr EnumValueSet VkSampleCountFlagsSets[] = {
    {"1", 0x00000001, false},  {"2", 0x00000002, false},  {"4", 0x00000004, false},
    {"8", 0x00000008, false},  {"16", 0x00000010, false}, {"32", 0x00000020, false},
    {"64", 0x00000040, false},
};

constexpr EnumValueSet VkAttachmentDescriptionFlagsSets[] = {
    {"MAY_ALIAS", 0x00000001, false},
};

constexpr EnumValueSet VkStencilFaceFlagsSets[] = {
...
constexpr EnumValueSet VkCullModeFlagsSets[] = {
    {"NONE", 0, false},
    {"FRONT", 0x00000001, false},
    {"BACK", 0x00000002, false},
    {"FRONT_AND_BACK", 0x00000003, false},
...
constexpr EnumValueSet VkDescriptorPoolCreateFlagsSets[] = {
...
constexpr EnumValueSet VkDependencyFlagsSets[] = {
...
constexpr EnumValueSet VkSubgroupFeatureFlagsSets[] = {
...
constexpr EnumValueSet VkIndirectCommandsLayoutUsageFlagsNVSets[] = {
    {"EXPLICIT_PREPROCESS", 0x00000001, false},
    {"INDEXED_SEQUENCES", 0x00000002, false},
    {"UNORDERED_SEQUENCES", 0x00000004, false},
};

constexpr EnumValueSet VkIndirectStateFlagsNVSets[] = {
    {"FLAG_FRONTFACE", 0x00000001, false},
};

constexpr EnumValueSet VkGeometryFlagsKHRSets[] = {
...
constexpr EnumValueSet VkGeometryInstanceFlagsKHRSets[] = {
...
constexpr EnumValueSet VkBuildAccelerationStructureFlagsKHRSets[] = {
...
constexpr EnumValueSet VkAccelerationStructureCreateFlagsKHRSets[] = {
    {"DEVICE_ADDRESS_CAPTURE_REPLAY", 0x00000001, false},
    {"RESERVED_BIT_2_NV", 0x00000004, false},
    {"MOTION_BIT_NV", 0x00000004, false},
};

constexpr EnumValueSet VkPipelineCreationFeedbackFlagsSets[] = {
...
constexpr EnumValueSet VkPerformanceCounterDescriptionFlagsKHRSets[] = {
...
constexpr EnumValueSet VkSemaphoreWaitFlagsSets[] = {
    {"ANY", 0x00000001, false},
    {"ANY_BIT_KHR", 0x00000001, true},
};

constexpr EnumValueSet VkDeviceDiagnosticsConfigFlagsNVSets[] = {
...
constexpr EnumValueSet VkAccessFlags2Sets[] = {
    {"NONE", 0, false},
    {"NONE_KHR", 0, true},
    {"INDIRECT_COMMAND_READ", 0x00000001, false},
...
constexpr EnumValueSet VkPipelineStageFlags2Sets[] = {
    {"NONE", 0, false},
    {"NONE_KHR", 0, true},
    {"TOP_OF_PIPE", 0x00000001, false},
...
constexpr EnumValueSet VkFormatFeatureFlags2Sets[] = {
    {"SAMPLED_IMAGE", 0x00000001, false},
...
constexpr EnumValueSet VkCompositeAlphaFlagsKHRSets[] = {
    {"OPAQUE", 0x00000001, false},
...
constexpr EnumValueSet VkDisplayPlaneAlphaFlagsKHRSets[] = {
    {"OPAQUE", 0x00000001, false},
...
constexpr EnumValueSet VkSurfaceTransformFlagsKHRSets[] = {
...
constexpr EnumValueSet VkSwapchainCreateFlagsKHRSets[] = {
    {"SPLIT_INSTANCE_BIND_REGIONS", 0x00000001, false},
    {"PROTECTED", 0x00000002, false},
    {"MUTABLE_FORMAT", 0x00000004, false},
};

constexpr EnumValueSet VkPeerMemoryFeatureFlagsSets[] = {
...
constexpr EnumValueSet VkMemoryAllocateFlagsSets[] = {
...
constexpr EnumValueSet VkDeviceGroupPresentModeFlagsKHRSets[] = {
...
constexpr EnumValueSet VkDebugReportFlagsEXTSets[] = {
...
constexpr EnumValueSet VkExternalMemoryHandleTypeFlagsNVSets[] = {
...
constexpr EnumValueSet VkExternalMemoryFeatureFlagsNVSets[] = {
    {"DEDICATED_ONLY", 0x00000001, false},
    {"EXPORTABLE", 0x00000002, false},
    {"IMPORTABLE", 0x00000004, false},
};

constexpr EnumValueSet VkExternalMemoryHandleTypeFlagsSets[] = {
...
constexpr EnumValueSet VkExternalMemoryFeatureFlagsSets[] = {
...
constexpr EnumValueSet VkExternalSemaphoreHandleTypeFlagsSets[] = {
    {"OPAQUE_FD", 0x00000001, false},
    {"OPAQUE_WIN32", 0x00000002, false},
    {"OPAQUE_WIN32_KMT", 0x00000004, false},
...
constexpr EnumValueSet VkExternalSemaphoreFeatureFlagsSets[] = {
...
constexpr EnumValueSet VkSemaphoreImportFlagsSets[] = {
    {"TEMPORARY", 0x00000001, false},
    {"TEMPORARY_BIT_KHR", 0x00000001, true},
};

constexpr EnumValueSet VkExternalFenceHandleTypeFlagsSets[] = {
    {"OPAQUE_FD", 0x00000001, false},
    {"OPAQUE_WIN32", 0x00000002, false},
    {"OPAQUE_WIN32_KMT", 0x00000004, false},
...
constexpr EnumValueSet VkExternalFenceFeatureFlagsSets[] = {
    {"EXPORTABLE", 0x00000001, false},
    {"IMPORTABLE", 0x00000002, false},
    {"EXPORTABLE_BIT_KHR", 0x00000001, true},
    {"IMPORTABLE_BIT_KHR", 0x00000002, true},
...
constexpr EnumValueSet VkFenceImportFlagsSets[] = {
    {"TEMPORARY", 0x00000001, false},
    {"TEMPORARY_BIT_KHR", 0x00000001, true},
};

constexpr EnumValueSet VkSurfaceCounterFlagsEXTSets[] = {
    {"VBLANK", 0x00000001, true},
    {"VBLANK", 0x00000001, false},
};

constexpr EnumValueSet VkDebugUtilsMessageSeverityFlagsEXTSets[] = {
...
constexpr EnumValueSet VkDebugUtilsMessageTypeFlagsEXTSets[] = {
    {"GENERAL", 0x00000001, false},
    {"VALIDATION", 0x00000002, false},
    {"PERFORMANCE", 0x00000004, false},
};

constexpr EnumValueSet VkDescriptorBindingFlagsSets[] = {
...
constexpr EnumValueSet VkConditionalRenderingFlagsEXTSets[] = {
    {"INVERTED", 0x00000001, false},
};

constexpr EnumValueSet VkResolveModeFlagsSets[] = {
    {"NONE", 0, false},
...
constexpr EnumValueSet VkSwapchainImageUsageFlagsANDROIDSets[] = {
    {"SHARED", 0x00000001, false},
};

constexpr EnumValueSet VkToolPurposeFlagsSets[] = {
...
constexpr EnumValueSet VkSubmitFlagsSets[] = {
    {"PROTECTED", 0x00000001, false},
    {"PROTECTED_BIT_KHR", 0x00000001, true},
};

constexpr EnumValueSet VkImageConstraintsInfoFlagsFUCHSIASets[] = {
...
constexpr EnumValueSet VkVideoCodecOperationFlagsKHRSets[] = {
    {"INVALID", 0, false},
...
constexpr EnumValueSet VkVideoCapabilityFlagsKHRSets[] = {
    {"PROTECTED_CONTENT", 0x00000001, false},
    {"SEPARATE_REFERENCE_IMAGES", 0x00000002, false},
};

constexpr EnumValueSet VkVideoSessionCreateFlagsKHRSets[] = {
    {"DEFAULT", 0, false},
    {"PROTECTED_CONTENT", 0x00000001, false},
};

constexpr EnumValueSet VkVideoCodingQualityPresetFlagsKHRSets[] = {
...
constexpr EnumValueSet VkVideoCodingControlFlagsKHRSets[] = {
    {"DEFAULT", 0, false},
    {"RESET", 0x00000001, false},
};

constexpr EnumValueSet VkVideoDecodeCapabilityFlagsKHRSets[] = {
    {"DEFAULT", 0, false},
    {"DPB_AND_OUTPUT_COINCIDE", 0x00000001, false},
    {"DPB_AND_OUTPUT_DISTINCT", 0x00000002, false},
};

constexpr EnumValueSet VkVideoDecodeFlagsKHRSets[] = {
    {"DEFAULT", 0, false},
    {"RESERVED_0", 0x00000001, false},
};

constexpr EnumValueSet VkVideoDecodeH264PictureLayoutFlagsEXTSets[] = {
    {"PROGRESSIVE", 0, false},
    {"INTERLACED_INTERLEAVED_LINES", 0x00000001, false},
    {"INTERLACED_SEPARATE_PLANES", 0x00000002, false},
};

constexpr EnumValueSet VkVideoEncodeFlagsKHRSets[] = {
    {"DEFAULT", 0, false},
    {"RESERVED_0", 0x00000001, false},
};

constexpr EnumValueSet VkVideoEncodeCapabilityFlagsKHRSets[] = {
    {"DEFAULT", 0, false},
    {"PRECEDING_EXTERNALLY_ENCODED_BYTES", 0x00000001, false},
};

constexpr EnumValueSet VkVideoEncodeRateControlFlagsKHRSets[] = {
    {"DEFAULT", 0, false},
    {"RESET", 0x00000001, false},
    {"RESERVED_0", 0x00000001, false},
};

constexpr EnumValueSet VkVideoEncodeRateControlModeFlagsKHRSets[] = {
    {"NONE", 0, false},
    {"CBR", 1, false},
    {"VBR", 2, false},
};

constexpr EnumValueSet VkVideoChromaSubsamplingFlagsKHRSets[] = {
    {"INVALID", 0, false},      {"MONOCHROME", 0x00000001, false}, {"420", 0x00000002, false},
    {"422", 0x00000004, false}, {"444", 0x00000008, false},
};

constexpr EnumValueSet VkVideoComponentBitDepthFlagsKHRSets[] = {
    {"INVALID", 0, false},
    {"8", 0x00000001, false},
    {"10", 0x00000004, false},
    {"12", 0x00000010, false},
...
constexpr EnumValueSet VkVideoEncodeH264CapabilityFlagsEXTSets[] = {
...
constexpr EnumValueSet VkVideoEncodeH264InputModeFlagsEXTSets[] = {
    {"FRAME", 0x00000001, false},
    {"SLICE", 0x00000002, false},
    {"NON_VCL", 0x00000004, false},
};

constexpr EnumValueSet VkVideoEncodeH264OutputModeFlagsEXTSets[] = {
    {"FRAME", 0x00000001, false},
    {"SLICE", 0x00000002, false},
    {"NON_VCL", 0x00000004, false},
};
...
constexpr EnumValueSet VkVideoEncodeH265CapabilityFlagsEXTSets[] = {
...
constexpr EnumValueSet VkVideoEncodeH265InputModeFlagsEXTSets[] = {
    {"FRAME", 0x00000001, false},
    {"NON_VCL", 0x00000004, false},
    {"SLICE", 0x00000002, false},
...
constexpr EnumValueSet VkVideoEncodeH265OutputModeFlagsEXTSets[] = {
    {"FRAME", 0x00000001, false},
    {"NON_VCL", 0x00000004, false},
    {"SLICE", 0x00000002, false},
    {"SLICE_SEGMENT", 0x00000002, false},
...
constexpr EnumValueSet VkVideoEncodeH265RateControlStructureFlagsEXTSets[] = {
    {"UNKNOWN", 0, false},
    {"FLAT", 0x00000001, false},
    {"DYADIC", 0x00000002, false},
};

constexpr EnumValueSet VkVideoEncodeH265CtbSizeFlagsEXTSets[] = {
    {"16", 0x00000001, false},
    {"32", 0x00000002, false},
    {"64", 0x00000004, false},
    {"8", 0x00000001, false},
...
constexpr EnumValueSet VkVideoEncodeH265TransformBlockSizeFlagsEXTSets[] = {
    {"4", 0x00000001, false},
    {"8", 0x00000002, false},
    {"16", 0x00000004, false},
    {"32", 0x00000008, false},
...
constexpr EnumValueSet VkVideoDecodeH264FieldLayoutFlagsEXTSets[] = {
...
constexpr EnumValueSet VkVideoEncodeH264CapabilitiesFlagsEXTSets[] = {
...
constexpr EnumValueSet VkIndirectCommandsLayoutUsageFlagsNVXSets[] = {
...
constexpr EnumValueSet VkObjectEntryUsageFlagsNVXSets[] = {
    {"GRAPHICS", 0x00000001, false},
    {"COMPUTE", 0x00000002, false},
};
...
constexpr EnumValueSet VkGeometryFlagsNVXSets[] = {
    {"OPAQUE", 0x00000001, false},
    {"NO_DUPLICATE_ANY_HIT_INVOCATION", 0x00000002, false},
};

constexpr EnumValueSet VkGeometryInstanceFlagsNVXSets[] = {
...
constexpr EnumValueSet VkBuildAccelerationStructureFlagsNVXSets[] = {
...
constexpr std::array<EnumType, 282> enumTypes = {{
    {"VkFramebufferCreateFlags", VkFramebufferCreateFlagsSets, 2, true},
    {"VkQueryPoolCreateFlags", nullptr, 0, true},
    ...
    {"VkPipelineDynamicStateCreateFlags", nullptr, 0, true},
    {"VkPipelineColorBlendStateCreateFlags", VkPipelineColorBlendStateCreateFlagsSets, 1, true},
    {"VkPipelineMultisampleStateCreateFlags", nullptr, 0, true},
    {"VkPipelineRasterizationStateCreateFlags", nullptr, 0, true},
    {"VkPipelineViewportStateCreateFlags", nullptr, 0, true},
    {"VkPipelineTessellationStateCreateFlags", nullptr, 0, true},
    {"VkPipelineInputAssemblyStateCreateFlags", nullptr, 0, true},
    {"VkPipelineVertexInputStateCreateFlags", nullptr, 0, true},
    ...
    {"VkBufferViewCreateFlags", nullptr, 0, true},
    {"VkInstanceCreateFlags", VkInstanceCreateFlagsSets, 1, true},
    {"VkDeviceCreateFlags", nullptr, 0, true},
    ...
    {"VkSemaphoreCreateFlags", nullptr, 0, true},
    ...
    {"VkMemoryMapFlags", nullptr, 0, true},
    ...
    {"VkDescriptorPoolResetFlags", nullptr, 0, true},
    ...
    {"VkPrivateDataSlotCreateFlags", nullptr, 0, true},
    {"VkAccelerationStructureCreateFlagsKHR", VkAccelerationStructureCreateFlagsKHRSets, 3, false},
    {"VkDescriptorUpdateTemplateCreateFlags", nullptr, 0, true},
    ...
    {"VkPerformanceCounterDescriptionFlagsKHR", VkPerformanceCounterDescriptionFlagsKHRSets, 4,
     false},
    {"VkAcquireProfilingLockFlagsKHR", nullptr, 0, true},
    {"VkSemaphoreWaitFlags", VkSemaphoreWaitFlagsSets, 2, false},
    {"VkPipelineCompilerControlFlagsAMD", nullptr, 0, true},
    {"VkShaderCorePropertiesFlagsAMD", nullptr, 0, true},
    ...
    {"VkDisplayModeCreateFlagsKHR", nullptr, 0, true},
    {"VkDisplaySurfaceCreateFlagsKHR", nullptr, 0, true},
    {"VkAndroidSurfaceCreateFlagsKHR", nullptr, 0, true},
    {"VkViSurfaceCreateFlagsNN", nullptr, 0, true},
    {"VkWaylandSurfaceCreateFlagsKHR", nullptr, 0, true},
    {"VkWin32SurfaceCreateFlagsKHR", nullptr, 0, true},
    {"VkXlibSurfaceCreateFlagsKHR", nullptr, 0, true},
    {"VkXcbSurfaceCreateFlagsKHR", nullptr, 0, true},
    {"VkDirectFBSurfaceCreateFlagsEXT", nullptr, 0, true},
    {"VkIOSSurfaceCreateFlagsMVK", nullptr, 0, true},
    {"VkMacOSSurfaceCreateFlagsMVK", nullptr, 0, true},
    {"VkMetalSurfaceCreateFlagsEXT", nullptr, 0, true},
    {"VkImagePipeSurfaceCreateFlagsFUCHSIA", nullptr, 0, true},
    {"VkStreamDescriptorSurfaceCreateFlagsGGP", nullptr, 0, true},
    {"VkHeadlessSurfaceCreateFlagsEXT", nullptr, 0, true},
    {"VkScreenSurfaceCreateFlagsQNX", nullptr, 0, true},
    ...
    {"VkCommandPoolTrimFlags", nullptr, 0, true},
    ...
    {"VkPipelineViewportSwizzleStateCreateFlagsNV", nullptr, 0, true},
    {"VkPipelineDiscardRectangleStateCreateFlagsEXT", nullptr, 0, true},
    {"VkPipelineCoverageToColorStateCreateFlagsNV", nullptr, 0, true},
    {"VkPipelineCoverageModulationStateCreateFlagsNV", nullptr, 0, true},
    {"VkPipelineCoverageReductionStateCreateFlagsNV", nullptr, 0, true},
    {"VkValidationCacheCreateFlagsEXT", nullptr, 0, true},
    ...
    {"VkDebugUtilsMessengerCreateFlagsEXT", nullptr, 0, true},
    {"VkDebugUtilsMessengerCallbackDataFlagsEXT", nullptr, 0, true},
    {"VkDeviceMemoryReportFlagsEXT", nullptr, 0, true},
    {"VkPipelineRasterizationConservativeStateCreateFlagsEXT", nullptr, 0, true},
    ...
    {"VkPipelineRasterizationStateStreamCreateFlagsEXT", nullptr, 0, true},
    {"VkPipelineRasterizationDepthClipStateCreateFlagsEXT", nullptr, 0, true},
    ...
    {"VkImageFormatConstraintsFlagsFUCHSIA", nullptr, 0, true},
    ...
    {"VkVideoBeginCodingFlagsKHR", nullptr, 0, true},
    {"VkVideoEndCodingFlagsKHR", nullptr, 0, true},
    ...
    {"VkMirSurfaceCreateFlagsKHR", nullptr, 0, true},
