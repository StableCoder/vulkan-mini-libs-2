...
constexpr std::array<EnumType, 229> enumTypes = {{
  {"VkImageLayout", VkImageLayoutSets, 31},
  ...
  {"VkQueryType", VkQueryTypeSets, 12},
  ...
  {"VkPipelineCacheCreateFlagBits", VkPipelineCacheCreateFlagBitsSets, 1},
  ...
  {"VkObjectType", VkObjectTypeSets, 46},
  {"VkQueueFlagBits", VkQueueFlagBitsSets, 7},
  {"VkCullModeFlagBits", VkCullModeFlagBitsSets, 4},
  {"VkRenderPassCreateFlagBits", VkRenderPassCreateFlagBitsSets, 1},
  {"VkDeviceQueueCreateFlagBits", VkDeviceQueueCreateFlagBitsSets, 1},
  {"VkMemoryPropertyFlagBits", VkMemoryPropertyFlagBitsSets, 9},
  {"VkMemoryHeapFlagBits", VkMemoryHeapFlagBitsSets, 3},
  {"VkAccessFlagBits", VkAccessFlagBitsSets, 35},
  {"VkBufferUsageFlagBits", VkBufferUsageFlagBitsSets, 25},
  {"VkBufferCreateFlagBits", VkBufferCreateFlagBitsSets, 7},
  {"VkShaderStageFlagBits", VkShaderStageFlagBitsSets, 29},
  {"VkImageUsageFlagBits", VkImageUsageFlagBitsSets, 18},
  {"VkImageCreateFlagBits", VkImageCreateFlagBitsSets, 19},
  {"VkImageViewCreateFlagBits", VkImageViewCreateFlagBitsSets, 2},
  {"VkSamplerCreateFlagBits", VkSamplerCreateFlagBitsSets, 2},
  {"VkPipelineCreateFlagBits", VkPipelineCreateFlagBitsSets, 22},
  {"VkPipelineShaderStageCreateFlagBits", VkPipelineShaderStageCreateFlagBitsSets, 2},
  {"VkColorComponentFlagBits", VkColorComponentFlagBitsSets, 4},
  {"VkFenceCreateFlagBits", VkFenceCreateFlagBitsSets, 1},
  {"VkFormatFeatureFlagBits", VkFormatFeatureFlagBitsSets, 35},
  ...
  {"VkDescriptorPoolCreateFlagBits", VkDescriptorPoolCreateFlagBitsSets, 4},
  {"VkDependencyFlagBits", VkDependencyFlagBitsSets, 4},
  ...
  {"VkDebugReportObjectTypeEXT", VkDebugReportObjectTypeEXTSets, 41},
  ...
  {"VkDescriptorSetLayoutCreateFlagBits", VkDescriptorSetLayoutCreateFlagBitsSets, 3},
  {"VkExternalMemoryHandleTypeFlagBits", VkExternalMemoryHandleTypeFlagBitsSets, 20},
  {"VkExternalMemoryFeatureFlagBits", VkExternalMemoryFeatureFlagBitsSets, 6},
  {"VkExternalSemaphoreHandleTypeFlagBits", VkExternalSemaphoreHandleTypeFlagBitsSets, 12},
  ...
  {"VkExternalFenceHandleTypeFlagBits", VkExternalFenceHandleTypeFlagBitsSets, 8},
  ...
  {"VkMemoryAllocateFlagBits", VkMemoryAllocateFlagBitsSets, 5},
  {"VkDeviceGroupPresentModeFlagBitsKHR", VkDeviceGroupPresentModeFlagBitsKHRSets, 4},
  {"VkSwapchainCreateFlagBitsKHR", VkSwapchainCreateFlagBitsKHRSets, 1},
  ...
  {"VkSubpassDescriptionFlagBits", VkSubpassDescriptionFlagBitsSets, 4},
  ...
  {"VkDescriptorBindingFlagBits", VkDescriptorBindingFlagBitsSets, 8},
  ...
  {"VkBuildAccelerationStructureFlagBitsKHR", VkBuildAccelerationStructureFlagBitsKHRSets, 11},
  {"VkAccelerationStructureCreateFlagBitsKHR", VkAccelerationStructureCreateFlagBitsKHRSets, 2},
  ...
  {"VkAccessFlagBits2KHR", VkAccessFlagBits2KHRSets, 26},
  {"VkPipelineStageFlagBits2KHR", VkPipelineStageFlagBits2KHRSets, 30},
  ...
  {"VkAccelerationStructureMemoryRequirementsTypeKHR", VkAccelerationStructureMemoryRequirementsTypeKHRSets, 6},
