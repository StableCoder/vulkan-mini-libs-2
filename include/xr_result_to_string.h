...
static_assert((XR_CURRENT_API_VERSION & 0xffffffffULL) <= 37,
              "openxr header version is from after the maximum supported version of v37.");
#else
_Static_assert((XR_CURRENT_API_VERSION & 0xffffffffULL) >= 0,
               "openxr header version is from before the minimum supported version of v0.");
_Static_assert((XR_CURRENT_API_VERSION & 0xffffffffULL) <= 37,
               "openxr header version is from after the maximum supported version of v37.");
#endif
