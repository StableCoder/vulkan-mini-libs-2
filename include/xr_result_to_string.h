...
#if (XR_CURRENT_API_VERSION & 0xffffffffULL) > 59
#if _MSC_VER
#pragma message(                                                                                   \
    __FILE__                                                                                       \
    ": warning: XR_CURRENT_API_VERSION is higher than what the header fully supports (v59)")
#else
#warning "XR_CURRENT_API_VERSION is higher than what the header fully supports (v59)"
#endif
#endif
...
char const *XrResult_to_string(XrResult result) {
  ...
  case 1000528000:
    return "XR_BOUNDARY_VISIBILITY_SUPPRESSION_NOT_ALLOWED_META";
  case -1000571001:
