...
static_assert(VK_HEADER_VERSION <= 309,
              "VK_HEADER_VERSION is from after the maximum supported version of v309.");
#else
_Static_assert(VK_HEADER_VERSION >= 72,
               "VK_HEADER_VERSION is from before the minimum supported version of v72.");
_Static_assert(VK_HEADER_VERSION <= 309,
               "VK_HEADER_VERSION is from after the maximum supported version of v309.");
#endif
...
EnumValueSet const VkDescriptorSetLayoutCreateFlagsSets[] = {
    {"PUSH_DESCRIPTOR_BIT_KHR", 0x00000001, true},
    ...
    {"PUSH_DESCRIPTOR", 0x00000001, false},
};
...
EnumValueSet const VkImageUsageFlagsSets[] = {
    ...
    {"HOST_TRANSFER_BIT_EXT", 0x00400000, true},
    {"VIDEO_ENCODE_QUANTIZATION_DELTA_MAP_BIT_KHR", 0x02000000, false},
...
EnumValueSet const VkPipelineCreateFlagsSets[] = {
    ...
    {"NO_PROTECTED_ACCESS_BIT_EXT", 0x08000000, true},
    {"PROTECTED_ACCESS_ONLY_BIT_EXT", 0x40000000, true},
...
EnumValueSet const VkSubgroupFeatureFlagsSets[] = {
    ...
    {"ROTATE_BIT_KHR", 0x00000200, true},
    {"ROTATE_CLUSTERED_BIT_KHR", 0x00000400, true},
    {"ROTATE", 0x00000200, false},
    {"ROTATE_CLUSTERED", 0x00000400, false},
};
...
EnumValueSet const VkClusterAccelerationStructureGeometryFlagsNVSets[] = {
    {"CULL_DISABLE", 0x00000001, false},
    {"NO_DUPLICATE_ANYHIT_INVOCATION", 0x00000002, false},
    {"OPAQUE", 0x00000004, false},
};

EnumValueSet const VkClusterAccelerationStructureClusterFlagsNVSets[] = {
    {"ALLOW_DISABLE_OPACITY_MICROMAPS", 0x00000001, false},
};

EnumValueSet const VkClusterAccelerationStructureAddressResolutionFlagsNVSets[] = {
    {"INDIRECTED_DST_IMPLICIT_DATA", 0x00000001, false},
    {"INDIRECTED_SCRATCH_DATA", 0x00000002, false},
    {"INDIRECTED_DST_ADDRESS_ARRAY", 0x00000004, false},
    {"INDIRECTED_DST_SIZES_ARRAY", 0x00000008, false},
    {"INDIRECTED_SRC_INFOS_ARRAY", 0x00000010, false},
    {"INDIRECTED_SRC_INFOS_COUNT", 0x00000020, false},
};
...
EnumValueSet const VkFormatFeatureFlags2Sets[] = {
    ...
    {"HOST_IMAGE_TRANSFER_BIT_EXT", 0x400000000000, true},
    {"VIDEO_ENCODE_QUANTIZATION_DELTA_MAP_BIT_KHR", 0x2000000000000, false},
    {"VIDEO_ENCODE_EMPHASIS_MAP_BIT_KHR", 0x4000000000000, false},
    {"HOST_IMAGE_TRANSFER", 0x400000000000, false},
    {"ACCELERATION_STRUCTURE_RADIUS_BUFFER_BIT_NV", 0x8000000000000, false},
};
...
EnumValueSet const VkIndirectCommandsLayoutUsageFlagsEXTSets[] = {
    {"EXPLICIT_PREPROCESS", 0x00000001, false},
    {"UNORDERED_SEQUENCES", 0x00000002, false},
};

EnumValueSet const VkIndirectCommandsInputModeFlagsEXTSets[] = {
    {"VULKAN_INDEX_BUFFER", 0x00000001, false},
    {"DXGI_INDEX_BUFFER", 0x00000002, false},
};
...
EnumValueSet const VkPipelineCreateFlags2Sets[] = {
    ...
    {"DISABLE_OPTIMIZATION_BIT_KHR", 0x00000001, true},
    {"ALLOW_DERIVATIVES_BIT_KHR", 0x00000002, true},
    {"DERIVATIVE_BIT_KHR", 0x00000004, true},
    {"VIEW_INDEX_FROM_DEVICE_INDEX_BIT_KHR", 0x00000008, true},
    {"DISPATCH_BASE_BIT_KHR", 0x00000010, true},
    {"DEFER_COMPILE_BIT_NV", 0x00000020, false},
    {"CAPTURE_STATISTICS_BIT_KHR", 0x00000040, false},
    {"CAPTURE_INTERNAL_REPRESENTATIONS_BIT_KHR", 0x00000080, false},
    {"FAIL_ON_PIPELINE_COMPILE_REQUIRED_BIT_KHR", 0x00000100, true},
    {"EARLY_RETURN_ON_FAILURE_BIT_KHR", 0x00000200, true},
    {"LINK_TIME_OPTIMIZATION_BIT_EXT", 0x00000400, false},
    {"RETAIN_LINK_TIME_OPTIMIZATION_INFO_BIT_EXT", 0x00800000, false},
    {"LIBRARY_BIT_KHR", 0x00000800, false},
    {"RAY_TRACING_SKIP_TRIANGLES_BIT_KHR", 0x00001000, false},
    ...
    {"RAY_TRACING_SKIP_BUILT_IN_PRIMITIVES_BIT_KHR", 0x00001000, true},
    {"RAY_TRACING_ALLOW_SPHERES_AND_LINEAR_SWEPT_SPHERES_BIT_NV", 0x200000000, false},
};
...
EnumValueSet const VkBufferUsageFlags2Sets[] = {
    ...
    {"SHADER_DEVICE_ADDRESS", 0x00020000, false},
    {"EXECUTION_GRAPH_SCRATCH_BIT_AMDX", 0x02000000, false},
    {"TRANSFER_SRC_BIT_KHR", 0x00000001, true},
    {"TRANSFER_DST_BIT_KHR", 0x00000002, true},
    {"UNIFORM_TEXEL_BUFFER_BIT_KHR", 0x00000004, true},
    {"STORAGE_TEXEL_BUFFER_BIT_KHR", 0x00000008, true},
    {"UNIFORM_BUFFER_BIT_KHR", 0x00000010, true},
    {"STORAGE_BUFFER_BIT_KHR", 0x00000020, true},
    {"INDEX_BUFFER_BIT_KHR", 0x00000040, true},
    {"VERTEX_BUFFER_BIT_KHR", 0x00000080, true},
    {"INDIRECT_BUFFER_BIT_KHR", 0x00000100, true},
    {"CONDITIONAL_RENDERING_BIT_EXT", 0x00000200, false},
    {"SHADER_BINDING_TABLE_BIT_KHR", 0x00000400, false},
    {"RAY_TRACING_BIT_NV", 0x00000400, true},
    {"TRANSFORM_FEEDBACK_BUFFER_BIT_EXT", 0x00000800, false},
...
EnumValueSet const VkClusterAccelerationStructureIndexFormatFlagsNVSets[] = {
    {"8BIT", 0x00000001, false},
    {"16BIT", 0x00000002, false},
    {"32BIT", 0x00000004, false},
};
...
EnumValueSet const VkHostImageCopyFlagsSets[] = {
    ...
    {"MEMCPY_EXT", 0x00000001, true},
};

EnumValueSet const VkPartitionedAccelerationStructureInstanceFlagsNVSets[] = {
    {"FLAG_TRIANGLE_FACING_CULL_DISABLE", 0x00000001, false},
    {"FLAG_TRIANGLE_FLIP_FACING", 0x00000002, false},
    {"FLAG_FORCE_OPAQUE", 0x00000004, false},
    {"FLAG_FORCE_NO_OPAQUE", 0x00000008, false},
    {"FLAG_ENABLE_EXPLICIT_BOUNDING_BOX", 0x00000010, false},
};
...
EnumValueSet const VkVideoCodecOperationFlagsKHRSets[] = {
    ...
    {"DECODE_AV1", 0x00000004, false},          {"ENCODE_AV1", 0x00040000, false},
};
...
EnumValueSet const VkVideoSessionParametersCreateFlagsKHRSets[] = {
    {"QUANTIZATION_MAP_COMPATIBLE", 0x00000001, false},
};
...
EnumValueSet const VkVideoEncodeFlagsKHRSets[] = {
    {"DEFAULT", 0, false},
    {"RESERVED_0", 0x00000001, false},
    {"WITH_QUANTIZATION_DELTA_MAP", 0x00000001, false},
    {"WITH_EMPHASIS_MAP", 0x00000002, false},
};
...
EnumValueSet const VkVideoEncodeCapabilityFlagsKHRSets[] = {
    ...
    {"QUANTIZATION_DELTA_MAP", 0x00000004, false},
    {"EMPHASIS_MAP", 0x00000008, false},
};
...
EnumValueSet const VkVideoEncodeH264CapabilityFlagsKHRSets[] = {
    ...
    {"MB_QP_DIFF_WRAPAROUND", 0x00000200, false},
};
...
EnumValueSet const VkVideoEncodeH265CapabilityFlagsKHRSets[] = {
    ...
    {"CU_QP_DIFF_WRAPAROUND", 0x00000400, false},
};
...
EnumValueSet const VkVideoEncodeAV1CapabilityFlagsKHRSets[] = {
    {"VK_VIDEO_ENCODE_AV1_CAPABILITY_PER_RATE_CONTROL_GROUP_MIN_MAX_Q_INDEX", 0x00000001, false},
    {"VK_VIDEO_ENCODE_AV1_CAPABILITY_GENERATE_OBU_EXTENSION_HEADER", 0x00000002, false},
    {"VK_VIDEO_ENCODE_AV1_CAPABILITY_PRIMARY_REFERENCE_CDF_ONLY", 0x00000004, false},
    {"VK_VIDEO_ENCODE_AV1_CAPABILITY_FRAME_SIZE_OVERRIDE", 0x00000008, false},
    {"VK_VIDEO_ENCODE_AV1_CAPABILITY_MOTION_VECTOR_SCALING", 0x00000010, false},
};

EnumValueSet const VkVideoEncodeAV1StdFlagsKHRSets[] = {
    {"VK_VIDEO_ENCODE_AV1_STD_UNIFORM_TILE_SPACING_FLAG_SET", 0x00000001, false},
    {"VK_VIDEO_ENCODE_AV1_STD_SKIP_MODE_PRESENT_UNSET", 0x00000002, false},
    {"VK_VIDEO_ENCODE_AV1_STD_PRIMARY_REF_FRAME", 0x00000004, false},
    {"VK_VIDEO_ENCODE_AV1_STD_DELTA_Q", 0x00000008, false},
};

EnumValueSet const VkVideoEncodeAV1RateControlFlagsKHRSets[] = {
    {"VK_VIDEO_ENCODE_AV1_RATE_CONTROL_REGULAR_GOP", 0x00000001, false},
    {"VK_VIDEO_ENCODE_AV1_RATE_CONTROL_TEMPORAL_LAYER_PATTERN_DYADIC", 0x00000002, false},
    {"VK_VIDEO_ENCODE_AV1_RATE_CONTROL_REFERENCE_PATTERN_FLAT", 0x00000004, false},
    {"VK_VIDEO_ENCODE_AV1_RATE_CONTROL_REFERENCE_PATTERN_DYADIC", 0x00000008, false},
};
...
EnumValueSet const VkAttachmentLoadOpSets[] = {
    ...
    {"NONE_KHR", 1000400000, true},
    {"NONE", 1000400000, false},
};
...
EnumValueSet const VkDescriptorTypeSets[] = {
    ...
    {"PARTITIONED_ACCELERATION_STRUCTURE_NV", 1000570000, false},
};
...
EnumValueSet const VkDynamicStateSets[] = {
    ...
    {"LINE_STIPPLE_KHR", 1000259000, true},
    {"DEPTH_CLAMP_RANGE_EXT", 1000582000, false},
    {"LINE_STIPPLE", 1000259000, false},
};
...
EnumValueSet const VkFormatSets[] = {
    ...
    {"A1B5G5R5_UNORM_PACK16_KHR", 1000470000, true},
    {"A8_UNORM_KHR", 1000470001, true},
...
EnumValueSet const VkIndirectCommandsTokenTypeEXTSets[] = {
    {"EXECUTION_SET", 0, false},
    {"PUSH_CONSTANT", 1, false},
    {"SEQUENCE_INDEX", 2, false},
    {"INDEX_BUFFER", 3, false},
    {"VERTEX_BUFFER", 4, false},
    {"DRAW_INDEXED", 5, false},
    {"DRAW", 6, false},
    {"DRAW_INDEXED_COUNT", 7, false},
    {"DRAW_COUNT", 8, false},
    {"DISPATCH", 9, false},
    {"DRAW_MESH_TASKS_NV", 1000202002, false},
    {"DRAW_MESH_TASKS_COUNT_NV", 1000202003, false},
    {"DRAW_MESH_TASKS", 1000328000, false},
    {"DRAW_MESH_TASKS_COUNT", 1000328001, false},
    {"TRACE_RAYS2", 1000386004, false},
};
...
EnumValueSet const VkIndexTypeSets[] = {
    ...
    {"UINT8_KHR", 1000265000, true},
    {"UINT8", 1000265000, false},
};
...
EnumValueSet const VkClusterAccelerationStructureTypeNVSets[] = {
    {"CLUSTERS_BOTTOM_LEVEL", 0, false},
    {"TRIANGLE_CLUSTER", 1, false},
    {"TRIANGLE_CLUSTER_TEMPLATE", 2, false},
};

EnumValueSet const VkClusterAccelerationStructureOpTypeNVSets[] = {
    {"MOVE_OBJECTS", 0, false},
    {"BUILD_CLUSTERS_BOTTOM_LEVEL", 1, false},
    {"BUILD_TRIANGLE_CLUSTER", 2, false},
    {"BUILD_TRIANGLE_CLUSTER_TEMPLATE", 3, false},
    {"INSTANTIATE_TRIANGLE_CLUSTER", 4, false},
};

EnumValueSet const VkClusterAccelerationStructureOpModeNVSets[] = {
    {"IMPLICIT_DESTINATIONS", 0, false},
    {"EXPLICIT_DESTINATIONS", 1, false},
    {"COMPUTE_SIZES", 2, false},
};
...
EnumValueSet const VkDescriptorUpdateTemplateTypeSets[] = {
    ...
    {"PUSH_DESCRIPTORS_KHR", 1, true},
    {"DESCRIPTOR_SET_KHR", 0, true},
    {"PUSH_DESCRIPTORS", 1, false},
};
...
EnumValueSet const VkQueueGlobalPrioritySets[] = {
    ...
    {"HIGH_EXT", 512, true},   {"REALTIME_EXT", 1024, true}, {"LOW_KHR", 128, true},
    {"MEDIUM_KHR", 256, true}, {"HIGH_KHR", 512, true},      {"REALTIME_KHR", 1024, true},
};
...
EnumValueSet const VkGeometryTypeKHRSets[] = {
    ...
    {"TRIANGLES_NV", 0, true},
    {"AABBS_NV", 1, true},
    {"SPHERES_NV", 1000429004, false},
    {"LINEAR_SWEPT_SPHERES_NV", 1000429005, false},
};
...
EnumValueSet const VkLineRasterizationModeSets[] = {
    {"DEFAULT", 0, false},      {"RECTANGULAR", 1, false},
    {"BRESENHAM", 2, false},    {"RECTANGULAR_SMOOTH", 3, false},
    {"DEFAULT_EXT", 0, true},   {"RECTANGULAR_EXT", 1, true},
    {"BRESENHAM_EXT", 2, true}, {"RECTANGULAR_SMOOTH_EXT", 3, true},
    {"DEFAULT_KHR", 0, true},   {"RECTANGULAR_KHR", 1, true},
    {"BRESENHAM_KHR", 2, true}, {"RECTANGULAR_SMOOTH_KHR", 3, true},
};
...
EnumValueSet const VkPipelineRobustnessBufferBehaviorSets[] = {
    {"DEVICE_DEFAULT", 0, false},          {"DISABLED", 1, false},
    {"ROBUST_BUFFER_ACCESS", 2, false},    {"ROBUST_BUFFER_ACCESS_2", 3, false},
    {"DEVICE_DEFAULT_EXT", 0, true},       {"DISABLED_EXT", 1, true},
    {"ROBUST_BUFFER_ACCESS_EXT", 2, true}, {"ROBUST_BUFFER_ACCESS_2_EXT", 3, true},
};

EnumValueSet const VkPipelineRobustnessImageBehaviorSets[] = {
    {"DEVICE_DEFAULT", 0, false},         {"DISABLED", 1, false},
    {"ROBUST_IMAGE_ACCESS", 2, false},    {"ROBUST_IMAGE_ACCESS_2", 3, false},
    {"DEVICE_DEFAULT_EXT", 0, true},      {"DISABLED_EXT", 1, true},
    {"ROBUST_IMAGE_ACCESS_EXT", 2, true}, {"ROBUST_IMAGE_ACCESS_2_EXT", 3, true},
};
...
EnumValueSet const VkOpacityMicromapSpecialIndexEXTSets[] = {
    ...
    {"CLUSTER_GEOMETRY_DISABLE_OPACITY_MICROMAP_NV", -5, false},
};
...
EnumValueSet const VkPartitionedAccelerationStructureOpTypeNVSets[] = {
    {"WRITE_INSTANCE", 0, false},
    {"UPDATE_INSTANCE", 1, false},
    {"WRITE_PARTITION_TRANSLATION", 2, false},
};
...
EnumValueSet const VkComponentTypeKHRSets[] = {
    ...
    {"UINT32_NV", 9, true},
    {"UINT64_NV", 10, true},
    {"SINT8_PACKED_NV", 1000491000, false},
...
EnumValueSet const VkDepthClampModeEXTSets[] = {
    {"VIEWPORT_RANGE", 0, false},
    {"USER_DEFINED_RANGE", 1, false},
};

EnumValueSet const VkCooperativeVectorMatrixLayoutNVSets[] = {
    {"ROW_MAJOR", 0, false},
    {"COLUMN_MAJOR", 1, false},
    {"INFERENCING_OPTIMAL", 2, false},
    {"TRAINING_OPTIMAL", 3, false},
};
...
EnumValueSet const VkVideoEncodeAV1PredictionModeKHRSets[] = {
    {"VK_VIDEO_ENCODE_AV1_PREDICTION_MODE_INTRA_ONLY", 0, false},
    {"VK_VIDEO_ENCODE_AV1_PREDICTION_MODE_SINGLE_REFERENCE", 1, false},
    {"VK_VIDEO_ENCODE_AV1_PREDICTION_MODE_UNIDIRECTIONAL_COMPOUND", 2, false},
    {"VK_VIDEO_ENCODE_AV1_PREDICTION_MODE_BIDIRECTIONAL_COMPOUND", 3, false},
};

EnumValueSet const VkVideoEncodeAV1RateControlGroupKHRSets[] = {
    {"VK_VIDEO_ENCODE_AV1_RATE_CONTROL_GROUP_INTRA", 0, false},
    {"VK_VIDEO_ENCODE_AV1_RATE_CONTROL_GROUP_PREDICTIVE", 1, false},
    {"VK_VIDEO_ENCODE_AV1_RATE_CONTROL_GROUP_BIPREDICTIVE", 2, false},
};
...
EnumType const cEnumTypes[384] = {
    ...
    {"VkDescriptorSetLayoutCreateFlags", VkDescriptorSetLayoutCreateFlagsSets, 10},
    ...
    {"VkFormatFeatureFlags2", VkFormatFeatureFlags2Sets, 74},
    ...
    {"VkVideoEncodeFlagsKHR", VkVideoEncodeFlagsKHRSets, 4},
    ...
    {"VkVideoEncodeCapabilityFlagsKHR", VkVideoEncodeCapabilityFlagsKHRSets, 5},
    ...
    {"VkVideoEncodeH264CapabilityFlagsKHR", VkVideoEncodeH264CapabilityFlagsKHRSets, 10},
    ...
    {"VkVideoEncodeH265CapabilityFlagsKHR", VkVideoEncodeH265CapabilityFlagsKHRSets, 11},
    ...
    {"VkVideoEncodeH265TransformBlockSizeFlagsKHR", VkVideoEncodeH265TransformBlockSizeFlagsKHRSets,
     4},
    {"VkVideoEncodeAV1CapabilityFlagsKHR", VkVideoEncodeAV1CapabilityFlagsKHRSets, 5},
